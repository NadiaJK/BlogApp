...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://root:fokak2020@localhost:3306/blogpost'
...
class BlogPost(db.Model):
    ...
    Auteur = db.Column(db.String(100), nullable = False, default='Unknown')
...
def edit(id):
    ...
    if(request.method == 'POST'):
        ...
        post.Auteur= request.form['author']
        db.session.commit()
        return redirect('/post')
    else:    
